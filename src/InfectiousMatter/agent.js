...
Agent.prototype.draw_mask = function(ctx, agent_size) {
	...
	ctx.lineWidth = 1;
	ctx.fillRect(this.body.position.x-0.5*agent_size, this.body.position.y-agent_size, agent_size*1, agent_size-1);
	ctx.strokeRect(this.body.position.x-0.5*agent_size, this.body.position.y-agent_size, agent_size*1, agent_size-1);
	ctx.stroke()
